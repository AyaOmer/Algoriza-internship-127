...
namespace Vezeeta.RepositoriesImplementation
{
    public class DoctorRepository : IDoctorRepository
    {
        private readonly Entites _context;

        public DoctorRepository(Entites context) { _context = context; }
        ...
        public HttpStatusCode Add(AddAppointmentDTO appointmentInfo)
        {
            ...
            var doctor = _context.Doctors.FirstOrDefault<Docter>(d => d.doctorid == appointmentInfo.doctorId);
